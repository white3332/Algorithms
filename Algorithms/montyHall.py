...
UnchangeGame=[] 
ChangeGame=[]
for i in range(0, NGames): # 자동차는 랜덤하게 숨겨진다. 
    CarDoor=random.choice(["Door1", "Door2", "Door3"]) # 사용자가 첫 번째 선택을 한다. 
    UserDoor=random.choice(["Door1", "Door2", "Door3"]) # 호스트가 자동차가 있지 않은 문을 연다. 
